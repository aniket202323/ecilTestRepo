...
namespace BatchArchiveValidation.Helper
{
    public class UserRepository : IUserRepository
    {
        public User AuthorizeUser(string DomainUser,string userName)
        {
            ...
            try
            {
                 validUser = userData.AuthorizeUser(ConfigurationManager.ConnectionStrings["ServerName"].ConnectionString + ConfigurationManager.AppSettings["DatabaseConnection"], DomainUser);
            }
            catch
            {
